								...
								$PDO_query_produit_nouveau_image->closeCursor();
									...
									<div class="right-block">
											...
											<h4><a href="https://'.$_SERVER['SERVER_NAME'].'/'.$PARAM_url_non_doc_site.'ProduitDetails/'.$produit_nouveau['eg_produit_id'].'">';
												...
												echo'</a></h4>
													...
													if($produit_nouveau['eg_produit_dispo'] == 0){
                                                        ...
                                                        <div class="stock"><span class="label label-surcommande-produit">Sur commande</span></div>
										...
										if($produit_nouveau['eg_produit_dispo'] == 0 || $produit_nouveau['eg_produit_dispo'] == 4){
											...
											<div class="quantity">
											 <input type="number" name="quantity" onkeydown="return event.keyCode !== 69" id="quantity'.$produit_nouveau["eg_produit_id"].'" class="form-control-panier" min="1" step="1" value="1">
										   	</div>
